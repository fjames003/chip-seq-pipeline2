...
workflow chip {
    ...
    Array[File] bams_ = flatten([star.bam, bams])
    ...
    Array[File] ctl_bams_ = flatten([star_ctl.bam, ctl_bams])
...
task merge_fastq { # merge trimmed fastqs
    ...
    output {
        ...
        # this prefix will be later stripped in star task
...
task trim_adapters_pe { # merge trimmed fastqs
